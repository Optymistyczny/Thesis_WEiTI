...
\typPracy{i} % i - praca inżynierska, m - praca magisterska
\kierunek{Nazwa kierunku}
\specjalnosc{Nazwa specjalności}
\title{Niepotrzebnie długi i skomplikowany tytuł pracy \\
trudny do przeczytania, zrozumienia i wymówienia}
\author{Imię i nazwisko}
\album{liczba}
% Dodanie drugiego autora. W tym celu wystarczy użyć poniższej funckji
