...
%-------------------------------------
% Bardziej wyśrodkować (foto)+
% Więcej keywords (3 linie). Długość aktualna jest okej.+
% Angielski tytuł!+

% Powalczyć ze słowem "część" w spisie treści (w treści dać) -- potem zrobić addtocontents line +
%
% Każdy part to nazwa partu na jednej kartce +
%
% Problemy do analizy powykonawczej +
% 
% W spisie treści powinny pojawić się numerowane

% Podpisy ilustracji mają mieć większy margines!

% Nie ma akapitów jednozdaniowych
% str. 9 poprawić cudzysłowy

% Poprawić tabelę -- te krótsz
% na wzór tabeli 2. ze strony 51 w slajdachv
% Zagnieżdżenie można zrobić głębiej -- nie dotyczy to tylko spisu treści. W spisie treści nie zamieszczać
% ale w ciele może być 
%
% Spróbować 
%
